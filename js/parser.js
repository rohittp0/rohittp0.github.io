const parser = // Generated by Peggy 3.0.2.
//
// https://peggyjs.org/
(function() {
  "use strict";
...
function peg$parse(input, options) {
  ...
  var peg$e12 = peg$literalExpectation("__", false);
  var peg$e13 = peg$classExpectation(["_"], true, false);
  ...
  var peg$f3 = function(text, nl) { return text.join('') + (nl || ''); };
  var peg$f4 = function(link) {
	return '[[@;;;;' + link.url + ']' + link.text + ']';
};
  var peg$f5 = function(link) {
	return '[[!;;;;' + link.url + ']' + link.text + ']';
};
  var peg$f6 = function(text, url) {
	return {
    	text: text.join(''),
        url: url.join('')
    };
